      ...
      <AnimatePresence>
        {toasts.map((toast) => (
          <motion.div
            ...
            className="bg-[var(--color-bg-elevated)] border border-[var(--color-border)] shadow-xl rounded-xl p-4 flex items-start gap-4 max-w-sm"
          >
            <div className="bg-[#10B981]/20 p-2 rounded-full shrink-0">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-400 text-xs mt-1 leading-snug">{toast.message}</p>
            </div>
            <button 
