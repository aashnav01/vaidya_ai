...
const SkeletonCard = () => {
  return (
    <div className="w-full max-w-3xl mx-auto flex flex-col items-center justify-center py-20 px-6">
      <div className="w-full bg-white rounded-xl p-6 border border-[#E5E7EB] mb-6">
      ...
      <p className="text-[#0D9488] font-medium animate-pulse flex items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="animate-spin">
          <path d="M21 12a9 9 0 1 1-6.219-8.56"/>
        </svg>
        Analyzing consultation with Gemini 3 Flash...
      </p>
    </div>
  );
};
